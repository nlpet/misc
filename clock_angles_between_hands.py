...
Approach: Start with an example like 3:27. We can draw a picture
of a clock by selecting where the 3 hour hand is and where the
27 minute hand is.
"""
import sys

if len(sys.argv) < 3:
    sys.exit('Missing parameters - hours and minutes')
...
print("The angle between the hands at %s:%s is %s degrees" %
    (hours, minutes, angle_between))
